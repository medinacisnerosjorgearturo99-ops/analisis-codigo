...
def dashboard_url(project_key: str) -> str:
    """Retorna la URL pública del dashboard — usa PUBLIC_URL para que quede bien en la BD."""
    return f"{PUBLIC_URL}/dashboard?id={project_key}"