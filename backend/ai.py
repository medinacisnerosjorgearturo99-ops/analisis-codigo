...
1. RESUMEN GENERAL (1-2 oraciones sobre el estado del proyecto)

2. EVALUACIÓN (justifica brevemente cada puntuación del 1 al 10):
   - Seguridad: X/10
   - Mantenibilidad: X/10
   - Escalabilidad: X/10
   - Limpieza del código: X/10

3. TOP 3 PROBLEMAS Y CÓMO RESOLVERLOS:
   a) ...
   b) ...
   c) ...
